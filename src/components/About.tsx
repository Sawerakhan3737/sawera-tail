          ...
          <div className="flex-1 px-4 sm:px-0" data-aos="fade-left">
            ...
            <div className="space-y-4 mb-12">
              ...
              <div className="flex items-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="grow bg-gray-800 rounded-full h-2.5">
                  <div className="bg-gradient-to-r from-yellow-200 to-red-500 h-2.5 rounded-full transition-transform duration-300 w-10/12"></div>
                </div>
              </div>
              ...
              <div className="flex items-center" data-aos="fade-up" data-aos-delay="400">
                ...
                <div className="grow bg-gray-800 rounded-full h-2.5">
                  <div className="bg-gradient-to-r from-yellow-200 to-red-500 h-2.5 rounded-full transition-transform duration-300 w-9/12"></div>
                </div>
              </div>
            ...
            <div className="mt-12 mb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
              <div data-aos="fade-up" data-aos-delay="800">
                <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-red-500">1+</h3>
                <p>Years Experience</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="1000">
                <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-red-500">10+</h3>
                <p>Projects Completed</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="1200">
                <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-red-500">5+</h3>
                <p>Happy Clients</p>
              </div>
            </div>
          </div>
