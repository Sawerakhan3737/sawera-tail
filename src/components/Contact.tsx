        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            <div className="mb-4">
              ...
              <a href="mailto:sawerak894@gmail.com" className="hover:underline">sawerak894@gmail.com</a>
            </div>
            <div className="mb-4">
          ...
          <div className="flex-1 w-full">
            <form className="space-y-4">
              ...
              <button className="bg-gradient-to-r from-red-500 to-yellow-200 text-black transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full">
                Send
              </button>
            </form>
          </div>
